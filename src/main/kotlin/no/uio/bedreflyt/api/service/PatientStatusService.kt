...
class PatientStatusService @Autowired constructor(
    ...
    fun getPatientStatus(patientId: String): PatientStatus {
        return patientStatusRepository.findByPatientId(patientId) ?: throw IllegalArgumentException("Patient status not found")
    }
}